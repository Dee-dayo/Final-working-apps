...
public class MbtiPersonalityTest {
	...
	private static String[] [] firstQuestions = new String [5] [2];
	private static String[] firstQuestionsAnswer = new String [5];
	private static String[] [] secondQuestions = new String [5] [2];
	private static String[] secondQuestionsAnswer = new String [5];
	private static String[] [] thirdQuestions = new String [5] [2];
	private static String[] thirdQuestionsAnswer = new String [5];
	private static String[] [] fourthQuestions = new String [5] [2];
	private static String[] fourthQuestionsAnswer = new String [5];
	private static String[] personalityType = new String [4];
	...
	thirdSetOfQuestions() ;
	fourthSetOfQuestions() ;
	System.out.println("\n\n\nHello " + name + ", You selected");
	firstDisplayMessage() ;
	secondDisplayMessage();
	thirdDisplayMessage();
	fourthDisplayMessage();
	System.out.println("\n");
	displayPersonalityTrait() ;
//	System.out.print(Arrays.toString(personalityType));
	
	}

	public static void firstSetOfQuestions() {
		firstQuestions [0] [0] = "A.  Expend energy, enjoy groups";
		firstQuestions [0] [1] = "B.  Conserve energy, enjoy one-on-one";
		firstQuestions [1] [0] = "A.  More outgoing, think out loud";
		firstQuestions [1] [1] = "B.  More reserved, think to yourself";
		firstQuestions [2] [0] = "A.  Seek many tasks, public activities, interaction with others";
		firstQuestions [2] [1] = "B.  Seek private, solitary activities with quiet to concentrate";
		firstQuestions [3] [0] = "A.  External, communicative, express yourself";
		firstQuestions [3] [1] = "B.  Internal, reticent, keep to yourself";
		firstQuestions [4] [0] = "A.  Active, initiate";
		firstQuestions [4] [1] = "B.  Reflective, deliberate";

		int count = 0;

		for (int index = 0; index < firstQuestions.length; index ++) {

			for (int deeper = 0; deeper < firstQuestions[index].length; deeper++) {
				System.out.print(firstQuestions[index][deeper] + "\t\t");
			}
			System.out.println();
			
			String answer = input.nextLine().toUpperCase();
				while (!answer.equals("A") && !answer.equals("B")) {
					System.out.println("You must select between A or B");
					answer = input.nextLine().toUpperCase();
				}
			if (answer.equals("A")) {
				firstQuestionsAnswer[count] = firstQuestions[index][0] ;
			} else {
				firstQuestionsAnswer[count] = firstQuestions[index][1] ;
			}
			count++;
			System.out.println();
		}
	...
	public static void secondSetOfQuestions() {
		secondQuestions [0] [0] = "A.  Interpret literally";
		secondQuestions [0] [1] = "B.  Look for meaning and possibilities";
		secondQuestions [1] [0] = "A.  Practical, realistic, experimental";
		secondQuestions [1] [1] = "B.  Imaginative, innovative, theoretical";
		secondQuestions [2] [0] = "A.  Standard, usual, conventional";
		secondQuestions [2] [1] = "B.  Different, novel, unique";
		secondQuestions [3] [0] = "A.  Focus on here-and now";
		secondQuestions [3] [1] = "B.  Look to the future, global perspective, big picture";
		secondQuestions [4] [0] = "A.  Facts, things, what is";
		secondQuestions [4] [1] = "B.  Ideas, dreams, what could be, philosophical";

		int count = 0;

		for (int index = 0; index < secondQuestions.length; index ++) {

			for (int deeper = 0; deeper < secondQuestions[index].length; deeper++) {
				System.out.print(secondQuestions[index][deeper] + "\t\t");
			}
			System.out.println();
			...
			if (answer.equals("A")) {
				secondQuestionsAnswer[count] = secondQuestions[index][0] ;
			} else {
				secondQuestionsAnswer[count] = secondQuestions[index][1] ;
			}
			count++;
			System.out.println();
		}
	...
	public static void thirdSetOfQuestions() {
		thirdQuestions [0] [0] = "A.  Logical, thinking, questioning";
		thirdQuestions [0] [1] = "B.  Empathetic, feeling, accomodating";
		thirdQuestions [1] [0] = "A.  Candid, straight forward, frank";
		thirdQuestions [1] [1] = "B.  Tactful, kind, encouraging";
		thirdQuestions [2] [0] = "A.  Firm, tend to criticize, hold the line";
		thirdQuestions [2] [1] = "B.  Gentle, tend to appreciate, conciliate";
		thirdQuestions [3] [0] = "A.  Tough-minded, just";
		thirdQuestions [3] [1] = "B.  Tender-hearted, merciful";
		thirdQuestions [4] [0] = "A.  Matter of fact, issue-oriented";
		thirdQuestions [4] [1] = "B.  Sensitive, people-oriented, compassionate";

		int count = 0;

		for (int index = 0; index < thirdQuestions.length; index ++) {

			for (int deeper = 0; deeper < thirdQuestions[index].length; deeper++) {
				System.out.print(thirdQuestions[index][deeper] + "\t\t");
			}
			System.out.println();
			...
			if (answer.equals("A")) {
				thirdQuestionsAnswer[count] = thirdQuestions[index][0] ;
			} else {
				thirdQuestionsAnswer[count] = thirdQuestions[index][1] ;
			}
			count++;
			System.out.println();
		}
	...
	public static void fourthSetOfQuestions() {
		fourthQuestions [0] [0] = "A.  Organized, orderly";
		fourthQuestions [0] [1] = "B.  Flexible, adaptable";
		fourthQuestions [1] [0] = "A.  Plan, schedule";
		fourthQuestions [1] [1] = "B.  Unplanned, spontaneous";
		fourthQuestions [2] [0] = "A.  Regulated, structured";
		fourthQuestions [2] [1] = "B.  Easy-going, live and let live";
		fourthQuestions [3] [0] = "A.  Preparation, plan ahead";
		fourthQuestions [3] [1] = "B.  Go with the flow, adapt as you go";
		fourthQuestions [4] [0] = "A.  Control, govern";
		fourthQuestions [4] [1] = "B.  Latitude, freedom";

		int count = 0;

		for (int index = 0; index < fourthQuestions.length; index ++) {

			for (int deeper = 0; deeper < fourthQuestions[index].length; deeper++) {
				System.out.print(fourthQuestions[index][deeper] + "\t\t");
			}
			System.out.println();
			...
			if (answer.equals("A")) {
				fourthQuestionsAnswer[count] = fourthQuestions[index][0] ;
			} else {
				fourthQuestionsAnswer[count] = fourthQuestions[index][1] ;
			}
			count++;
			System.out.println();
		}
	...
	public static void firstDisplayMessage() {
		int noOfA = 0;
       		int noOfB = 0;

		for (int index = 0; index < firstQuestionsAnswer.length; index++) {
			System.out.println(firstQuestionsAnswer[index]);

			if (firstQuestionsAnswer[index].startsWith("A")) {
				noOfA++;
			} else
				if (firstQuestionsAnswer[index].startsWith("B")) {
				noOfB++;
            			}
        		}
	...
	public static void secondDisplayMessage() {
		System.out.println("\n\n");
		int noOfA = 0;
       		int noOfB = 0;

		for (int index = 0; index < secondQuestionsAnswer.length; index++) {
			System.out.println(secondQuestionsAnswer[index]);

			if (secondQuestionsAnswer[index].startsWith("A")) {
				noOfA++;
			} else
				if (secondQuestionsAnswer[index].startsWith("B")) {
				noOfB++;
            			}
        		}
        System.out.println("Number of A selected: " + noOfA);
	...
	public static void thirdDisplayMessage() {
		System.out.println("\n\n");
		int noOfA = 0;
       		int noOfB = 0;

		for (int index = 0; index < thirdQuestionsAnswer.length; index++) {
			System.out.println(thirdQuestionsAnswer[index]);

			if (thirdQuestionsAnswer[index].startsWith("A")) {
				noOfA++;
			} else
				if (thirdQuestionsAnswer[index].startsWith("B")) {
				noOfB++;
            			}
        		}
        System.out.println("Number of A selected: " + noOfA);
	...
	public static void fourthDisplayMessage() {
		System.out.println("\n\n");
		int noOfA = 0;
       		int noOfB = 0;

		for (int index = 0; index < fourthQuestionsAnswer.length; index++) {
			System.out.println(fourthQuestionsAnswer[index]);

			if (fourthQuestionsAnswer[index].startsWith("A")) {
				noOfA++;
			} else
				if (fourthQuestionsAnswer[index].startsWith("B")) {
				noOfB++;
            			}
        		}
        System.out.println("Number of A selected: " + noOfA);
	...
	public static void displayPersonalityTrait() {
		if (personalityType[0] == "I" && personalityType[1] == "N" && personalityType[2] == "T" && personalityType[3] == "J") {
